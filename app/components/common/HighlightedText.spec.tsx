...
describe('HighlightedText', () => {
  it('should render text without highlight when highlight is empty', () => {
    renderWithProviders(<HighlightedText text="Hello World" highlight="" />);
    expect(screen.getByText('Hello World')).toBeInTheDocument();
  });

  it('should render text without highlight when highlight is whitespace only', () => {
    renderWithProviders(<HighlightedText text="Test Text" highlight="  " />);
  ...
  it('should handle special regex characters in highlight', () => {
    ...
    renderWithProviders(<HighlightedText text="price is $50" highlight="$" />);
  ...
  it('should handle empty text', () => {
    const { container } = renderWithProviders(
      <HighlightedText text="" highlight="test" />
    );
  ...
  it('should render container span element', () => {
    const { container } = renderWithProviders(
      <HighlightedText text="Test" highlight="T" />
    );
