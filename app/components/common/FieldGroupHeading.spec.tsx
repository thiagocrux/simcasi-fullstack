...
describe('FieldGroupHeading', () => {
  it('should render label with provided text', () => {
    renderWithProviders(<FieldGroupHeading text="Personal Information" />);
    expect(screen.getByText('Personal Information')).toBeInTheDocument();
  });

  it('should render as label element', () => {
    renderWithProviders(<FieldGroupHeading text="Test" />);
  ...
  it('should render separator line', () => {
    const { container } = renderWithProviders(
      <FieldGroupHeading text="Section" />
    );
  ...
  it('should render label before separator', () => {
    const { container } = renderWithProviders(
      <FieldGroupHeading text="Heading" />
    );
    const wrapper = container.firstChild as HTMLElement;
  ...
  it('should handle long section titles', () => {
    ...
    renderWithProviders(<FieldGroupHeading text={longTitle} />);
    expect(screen.getByText(longTitle)).toBeInTheDocument();
  });

  it('should handle special characters in title', () => {
    const specialTitle = 'Patient Info & Consent (Required)';
    renderWithProviders(<FieldGroupHeading text={specialTitle} />);
