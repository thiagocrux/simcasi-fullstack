...
1. **Update OpenAPI Specification** — Modify the corresponding YAML file in `openapi/`. Follow the existing structure and include descriptions, parameters, and examples.
