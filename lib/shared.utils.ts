 ...
 * @return {Array<number|string>} Array of page numbers and/or ellipsis ('...').
 * @example
 ...
 * @return {ReactNode} Rendered node or fallback.
 * @example
 ...
 *
 * @return {string} The timezone offset string.
 * @example
 ...
 * @return {User|Patient|undefined} The entity matching the given ID, or `undefined` if not found.
 * @example
